...
//  Storyboard IDs
#define kLoginVCID              @"LoginNav"
#define kHomeVCID               @"HomeTab"
...
//  Regex
#define kRegexEmail             @"[A-Z0-9a-z._%+-]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,4}"

//  Survey Monkey Key
#define kSurveyKey              @"2T37ZS7"
...
// URL Scheme
#define kURLScheme              @"com.iOSDevs.iOS-Shopper18.payments"
